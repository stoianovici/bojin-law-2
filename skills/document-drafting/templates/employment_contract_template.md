...
**This Employment Agreement** ("Agreement") is entered into as of {{EFFECTIVE_DATE}} ("Effective Date") by and between:

**{{COMPANY_NAME}}**, a {{COMPANY_TYPE}} with its principal place of business at {{COMPANY_ADDRESS}} ("Employer" or "Company"), and

**{{EMPLOYEE_NAME}}**, an individual residing at {{EMPLOYEE_ADDRESS}} ("Employee").

## RECITALS

WHEREAS, Employer desires to employ Employee in the position of {{POSITION_TITLE}};
...
1.1 **Position.** Employee is employed as {{POSITION_TITLE}}, reporting to {{REPORTS_TO}}.

1.2 **Duties.** Employee shall perform the following duties:

{{JOB_DUTIES}}

1.3 **Loyalty and Dedication.** Employee shall devote Employee's full business time, attention, and energies to the performance of Employee's duties hereunder and shall not engage in any other business activity without Employer's prior written consent.

## 2. COMPENSATION AND BENEFITS

2.1 **Base Salary.** Employer shall pay Employee an annual base salary of {{BASE_SALARY}} ("Base Salary"), payable in accordance with Employer's standard payroll practices ({{PAY_FREQUENCY}}).
...
3.1 **At-Will Employment.** Employee's employment is at-will, meaning either party may terminate the employment relationship at any time, with or without cause and with or without notice, except as otherwise provided herein.
...
5.3 **Moral Rights.** Employee waives all moral rights in the Work Product to the fullest extent permitted by law.

5.4 **Prior Inventions.** Employee has disclosed to Employer all inventions developed prior to employment that Employee desires to exclude from this Agreement (attached as Schedule A, or "None" if no such inventions exist).
...
6.3 **Non-Solicitation of Employees.** During employment and for {{NON_SOLICIT_EMPLOYEES_PERIOD}} following termination, Employee shall not recruit, solicit, or induce any employee of Employer to leave employment or to become employed by any other person or entity.

6.4 **Reasonableness.** Employee acknowledges that the restrictions in this Section are reasonable and necessary to protect Employer's legitimate business interests.
...
8.1 Employee acknowledges receipt of Employer's Employee Handbook and agrees to comply with all policies and procedures contained therein, as may be amended from time to time.

## 9. DISPUTE RESOLUTION

9.1 **{{DISPUTE_RESOLUTION_METHOD}}** Any dispute arising under this Agreement shall be resolved through {{DISPUTE_RESOLUTION_METHOD}} (options: mediation, arbitration, litigation) in accordance with the rules of {{DISPUTE_RESOLUTION_RULES}}, administered in {{JURISDICTION}}.

9.2 **Legal Fees.** The prevailing party in any dispute shall be entitled to recover reasonable attorneys' fees and costs.

## 10. GENERAL PROVISIONS

10.1 **Governing Law.** This Agreement shall be governed by the laws of {{JURISDICTION}}, without regard to conflict of laws principles.

10.2 **Entire Agreement.** This Agreement, together with the Employee Handbook and any referenced schedules, constitutes the entire agreement and supersedes all prior agreements and understandings.

10.3 **Amendment.** This Agreement may be amended only by a written instrument signed by both parties.

10.4 **Assignment.** Employee may not assign this Agreement. Employer may assign this Agreement to a successor entity in a merger or acquisition.

10.5 **Severability.** If any provision is held invalid, the remaining provisions shall continue in full force and effect. If any restrictive covenant is held unenforceable, it shall be modified to the minimum extent necessary to make it enforceable.

10.6 **Survival.** Sections 4 (Confidential Information), 5 (Intellectual Property), and 6 (Non-Compete and Non-Solicitation) shall survive termination of employment.

10.7 **Notices.** All notices shall be in writing and delivered to the addresses set forth above or such other address as designated in writing.

10.8 **Counterparts.** This Agreement may be executed in counterparts, each of which shall be deemed an original.

10.9 **Tax Withholding.** All compensation shall be subject to applicable tax withholding and reporting.
...
- `{{BONUS_PERCENTAGE}}`: Bonus target % (e.g., "15")
- `{{BONUS_TIMING}}`: When bonus is paid (e.g., "annually in Q1")
- `{{COMPANY_MATCH}}`: 401(k) match percentage (e.g., "4")
- `{{ADDITIONAL_BENEFITS}}`: Other benefits (stock options, gym membership, etc.)
- `{{PTO_DAYS}}`: Annual PTO days (e.g., "20")
...
- `{{COMPANY_SIGNATORY_NAME}}`, `{{COMPANY_SIGNATORY_TITLE}}`: Employer signer

**SCHEDULE A: Prior Inventions**
(Attach list or mark "None")
...
- Non-compete Reform Act (M.G.L. c. 149, § 24L) requirements:
  ...
  - Must be provided before job offer or 10 days before start
...
- Remote work provisions and equipment
