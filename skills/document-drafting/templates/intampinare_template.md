...
**Document Type:** Court Filing / Legal Pleading
...
## COURT INFORMATION / DATE DE IDENTIFICARE INSTANȚĂ

**Către / To:**
{{INSTANTA_NUME}}
{{INSTANTA_ADRESA}}

**Dosar nr. / Case No.:** {{NUMAR_DOSAR}}
**Data depunerii / Filing date:** {{DATA_DEPUNERE}}
...
**{{PARAT_NUME}}**, {{PARAT_TIP_PERSOANA}}, domiciliat/cu sediul în {{PARAT_ADRESA}}, {{PARAT_IDENTIFICARE}}

Asistat de avocat / Represented by attorney:
**{{AVOCAT_PARAT_NUME}}**
Baroul {{BAROU_PARAT}}
Adresa: {{AVOCAT_PARAT_ADRESA}}

### împotriva / Against

**{{RECLAMANT_NUME}}**, {{RECLAMANT_TIP_PERSOANA}}, domiciliat/cu sediul în {{RECLAMANT_ADRESA}}, {{RECLAMANT_IDENTIFICARE}}
...
## I. EXPUNERE SUMARĂ A CAUZEI / SUMMARY OF THE CASE
...
## II. POZIȚIA PÂRÂTULUI / DEFENDANT'S POSITION
...
## III. EXCEPȚII / OBJECTIONS

### 3.1 Excepții procedurale / Procedural objections

{{#EXCEPTII_PROCEDURALE}}
**A. {{DENUMIRE_EXCEPTIE}}**

{{MOTIVARE_EXCEPTIE}}

**Temei legal / Legal basis:** {{TEMEI_LEGAL_EXCEPTIE}}

{{/EXCEPTII_PROCEDURALE}}

### 3.2 Excepții de fond / Substantive objections

{{#EXCEPTII_FOND}}
**B. {{DENUMIRE_EXCEPTIE_FOND}}**

{{MOTIVARE_EXCEPTIE_FOND}}

**Temei legal / Legal basis:** {{TEMEI_LEGAL_EXCEPTIE_FOND}}

{{/EXCEPTII_FOND}}

---

## IV. APĂRĂRI PE FOND / DEFENSES ON THE MERITS
...
### 4.2 Argumente / Arguments

**4.2.1 Primul argument / First argument:**
{{ARGUMENT_1}}

**Temei legal / Legal basis:** {{TEMEI_LEGAL_1}}

**4.2.2 Al doilea argument / Second argument:**
{{ARGUMENT_2}}

**Temei legal / Legal basis:** {{TEMEI_LEGAL_2}}

**4.2.3 Al treilea argument / Third argument:**
{{ARGUMENT_3}}

**Temei legal / Legal basis:** {{TEMEI_LEGAL_3}}
...
### 5.2 Proba cu martori / Witness testimony
...
### 5.3 Proba cu expertiză / Expert evidence
...
**Temei legal / Legal basis:** Art. 329-343 C.proc.civ.
{{/PROBA_EXPERTIZA}}

### 5.4 Alte probe / Other evidence

{{ALTE_PROBE}}

---

## VI. CERERI ACCESORII / ANCILLARY REQUESTS
...
### 6.2 Garanție pentru judecată / Security for costs
...
### 6.3 Suspendarea executării / Stay of execution
...
## VII. CERERE RECONVENȚIONALĂ / COUNTERCLAIM
...
## VIII. JURISPRUDENȚĂ ȘI DOCTRINĂ / CASE LAW AND DOCTRINE

### 8.1 Jurisprudență relevantă / Relevant case law

{{#JURISPRUDENTA}}
**{{INSTANTA_JURISP}}**, {{TIP_DECIZIE}} nr. {{NUMAR_DECIZIE}}/{{AN_DECIZIE}}:
"{{CITAT_JURISP}}"

**Relevanță:** {{RELEVANTA_JURISP}}
{{/JURISPRUDENTA}}

### 8.2 Doctrină / Legal doctrine
...
- `{{PARAT_IDENTIFICARE}}` - ID/CNP/CUI
- `{{RECLAMANT_NUME}}` - Plaintiff's name
- `{{RECLAMANT_TIP_PERSOANA}}` - Plaintiff type
- `{{RECLAMANT_ADRESA}}` - Plaintiff's address
...
- `{{#PROBA_EXPERTIZA}}...{{/PROBA_EXPERTIZA}}` - Expert evidence
- `{{#GARANTIE_JUDECATA}}...{{/GARANTIE_JUDECATA}}` - Security for costs
- `{{#SUSPENDARE_EXECUTARE}}...{{/SUSPENDARE_EXECUTARE}}` - Stay of execution
- `{{#CERERE_RECONVENTIONALA}}...{{/CERERE_RECONVENTIONALA}}` - Counterclaim
...
- Art. 296-311 - Documentary evidence
- Art. 312-328 - Witness testimony
- Art. 329-343 - Expert evidence
...
4. Requires attorney signature and stamp
5. File original + copies for each party
