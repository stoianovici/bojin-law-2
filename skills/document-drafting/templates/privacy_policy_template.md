...
{{COMPANY_NAME}} ("we," "us," "our") operates {{WEBSITE_URL}} ("Service"). This Privacy Policy explains how we collect, use, and protect your personal information.
...
**Legal Basis (GDPR):** {{LEGAL_BASIS}} (Consent | Contract performance | Legitimate interests | Legal obligation)
...
- **Aggregated Data:** Non-identifiable data for analytics

We **DO NOT** sell your personal information to third parties.

{{CCPA_DO_NOT_SELL}} (California residents: We do not sell your personal information.)
...
Deleted account data is removed within {{DELETION_TIMEFRAME}}, except as required by law.
...
**Exercise Rights:** Contact {{PRIVACY_EMAIL}} or use {{PRIVACY_SETTINGS_URL}}
...
However, no method is 100% secure. Use strong passwords and enable two-factor authentication.

## 7. INTERNATIONAL TRANSFERS

Your information may be transferred to {{DATA_LOCATIONS}} (e.g., United States, EU).

**GDPR Compliance:** We use Standard Contractual Clauses or adequacy decisions for transfers outside the EU/UK.

## 8. CHILDREN'S PRIVACY

The Service is not intended for users under {{MINIMUM_AGE}}. We do not knowingly collect information from children. If you believe we have collected children's data, contact {{PRIVACY_EMAIL}}.
...
The Service may link to third-party websites. We are not responsible for their privacy practices. Review their policies before providing information.

## 11. CHANGES TO THIS POLICY

We may update this Privacy Policy. Material changes will be notified via {{NOTIFICATION_METHOD}} (email, banner, {{NOTIFICATION_DAYS}} days notice).
...
**Data Protection Officer (GDPR):** {{DPO_EMAIL}} (if applicable)

**Mailing Address:**
{{COMPANY_NAME}}
{{COMPANY_ADDRESS}}

**EU Representative:** {{EU_REP}} (if required for GDPR)
