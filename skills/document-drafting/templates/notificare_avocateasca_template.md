...
## RECIPIENT INFORMATION / DESTINATAR

**Către / To:**
{{DESTINATAR_NUME}}
{{DESTINATAR_ADRESA}}

**Data / Date:** {{DATA_NOTIFICARE}}

---

## SENDER INFORMATION / EXPEDITOR

**De la / From:**
{{FIRMA_NUME}}
Prin avocat / Through attorney: {{AVOCAT_NUME}}
Baroul {{BAROU}}
{{FIRMA_ADRESA}}
...
**Termen de conformare / Compliance deadline:** {{TERMEN_CONFORMARE}}
...
**Avocat {{AVOCAT_NUME}}**
Baroul {{BAROU}}
Pentru și în numele {{FIRMA_NUME}}
...
- `{{BAROU}}` - Bar association name (e.g., "București")
- `{{FIRMA_ADRESA}}` - Sender address
- `{{OBIECT_NOTIFICARE}}` - Subject of notice
- `{{DATA_NOTIFICARE}}` - Notice date
- `{{DESCRIERE_FAPT}}` - Statement of facts
- `{{ACTIUNE_SOLICITATA}}` - Requested action
- `{{TERMEN_CONFORMARE}}` - Compliance deadline (e.g., "15 zile", "30 zile")
...
- `{{CONSECINTE_NECONFORMARE}}` - Consequences of non-compliance
...
4. Typically gives 15-30 days for compliance
5. Common Civil Code references:
   - Art. 1350 - General contract obligations
...
- Obligation to perform notifications
