...
describe('QualityMetricsService', () => {
  const mockInput: QualityMetricsInput & {
    ...
    finalContent:
      'This is the final content after user edits. It has some legal text with modifications.',
  ...
  describe('getMetricsSummary', () => {
    ...
    it('should return metrics summary', async () => {
      ...
      const result = await qualityMetricsService.getMetricsSummary(firmId, startDate, endDate);
    ...
    it('should filter by document type', async () => {
      await qualityMetricsService.getMetricsSummary(firmId, startDate, endDate, 'Contract');
  ...
  describe('getTrendingMetrics', () => {
    it('should return trending metrics', async () => {
      ...
      const result = await qualityMetricsService.getTrendingMetrics(mockInput.firmId, 30);
