...
- Filename patterns (image001.png, logo.*, signature.*)
...
| signature-files | Signature/Logo Files | signature.*, logo.*, banner.* | dismiss |
...
- [ ] Filter rules configuration file with default rules
- [ ] DocumentFilterService evaluates attachments against rules
- [ ] Dismissed attachments tracked in database (not downloaded)
- [ ] Filtering integrated into syncAllAttachments flow
- [ ] Logging shows filter decisions
- [ ] Migration for new EmailAttachment fields
