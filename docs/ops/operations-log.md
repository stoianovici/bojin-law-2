...
| OPS-223 | Actor Type Selection UI                               | Feature      | P2-Medium   | Closed           | [archive/ops-223.md](archive/ops-223.md) |
| OPS-224 | Fix Case Number Field Label                           | Bug          | P2-Medium   | Closed           | [archive/ops-224.md](archive/ops-224.md) |
| OPS-225 | OverviewTab Section Groups                            | Feature      | P2-Medium   | Closed           | [archive/ops-225.md](archive/ops-225.md) |
| OPS-226 | Client GraphQL Query + Resolver                       | Feature      | P2-Medium   | Closed           | [archive/ops-226.md](archive/ops-226.md) |
| OPS-227 | Client Profile Page + Case Links                      | Feature      | P2-Medium   | Closed           | [archive/ops-227.md](archive/ops-227.md) |
| OPS-228 | Fix Search - Graceful Fallback to Full-Text           | Bug          | P0-Critical | Closed           | [archive/ops-228.md](archive/ops-228.md) |
| OPS-229 | Remove Semantic Search from Backend                   | Refactor     | P2-Medium   | Closed           | [archive/ops-229.md](archive/ops-229.md) |
| OPS-230 | Simplify Search GraphQL Schema                        | Refactor     | P2-Medium   | Closed           | [archive/ops-230.md](archive/ops-230.md) |
| OPS-231 | Simplify Search Frontend                              | Refactor     | P2-Medium   | Closed           | [archive/ops-231.md](archive/ops-231.md) |
| OPS-232 | AI Usage & Batch Job Data Models                      | Feature      | P1-High     | Closed           | [archive/ops-232.md](archive/ops-232.md) |
| OPS-233 | AI Call Wrapper with Usage Logging                    | Feature      | P1-High     | Closed           | [archive/ops-233.md](archive/ops-233.md) |
| OPS-234 | Feature Configuration Data Model & Service            | Feature      | P1-High     | Closed           | [archive/ops-234.md](archive/ops-234.md) |
| OPS-235 | AI Usage Aggregation Service                          | Feature      | P1-High     | Closed           | [archive/ops-235.md](archive/ops-235.md) |
| OPS-236 | Batch Job Runner Framework                            | Feature      | P1-High     | Closed           | [archive/ops-236.md](archive/ops-236.md) |
| OPS-237 | Search Index Processor (Nightly)                      | Feature      | P1-High     | Closed           | [archive/ops-237.md](archive/ops-237.md) |
| OPS-238 | Morning Briefings Processor (Pre-compute)             | Feature      | P1-High     | Closed           | [archive/ops-238.md](archive/ops-238.md) |
| OPS-239 | Case Health Scoring Processor                         | Feature      | P2-Medium   | Closed           | [archive/ops-239.md](archive/ops-239.md) |
| OPS-240 | Thread Summaries Processor                            | Feature      | P2-Medium   | Closed           | [archive/ops-240.md](archive/ops-240.md) |
| OPS-241 | AI Ops GraphQL Schema & Resolvers                     | Feature      | P1-High     | Closed           | [archive/ops-241.md](archive/ops-241.md) |
| OPS-242 | AI Ops Dashboard Layout & Overview                    | Feature      | P2-Medium   | Closed           | [archive/ops-242.md](archive/ops-242.md) |
| OPS-243 | Feature Toggles Page                                  | Feature      | P2-Medium   | Closed           | [archive/ops-243.md](archive/ops-243.md) |
| OPS-244 | Cost Breakdown & Charts Page                          | Feature      | P2-Medium   | Closed           | [archive/ops-244.md](archive/ops-244.md) |
| OPS-245 | Batch Job History Page                                | Feature      | P2-Medium   | Closed           | [archive/ops-245.md](archive/ops-245.md) |
| OPS-246 | Budget Controls & Alerts Page                         | Feature      | P2-Medium   | Closed           | [archive/ops-246.md](archive/ops-246.md) |
| OPS-247 | Per-User AI Usage Dashboard                           | Feature      | P2-Medium   | Closed           | [archive/ops-247.md](archive/ops-247.md) |
| OPS-248 | Add document_drafting to AI Feature Config            | Feature      | P2-Medium   | Closed           | [archive/ops-248.md](archive/ops-248.md) |
| OPS-256 | AI Document Generation: Create .docx in SharePoint    | Feature      | P1-High     | Verifying        | [issues/ops-256.md](issues/ops-256.md)   |
| OPS-257 | Extend CaseBriefing Schema for Rich Context           | Feature      | P2-Medium   | Closed           | [archive/ops-257.md](archive/ops-257.md) |
| OPS-258 | Document Summary Aggregation Service                  | Feature      | P2-Medium   | Closed           | [archive/ops-258.md](archive/ops-258.md) |
| OPS-259 | Email Thread Summary Aggregation Service              | Feature      | P2-Medium   | Closed           | [archive/ops-259.md](archive/ops-259.md) |
| OPS-260 | Client Context Aggregation Service                    | Feature      | P2-Medium   | Closed           | [archive/ops-260.md](archive/ops-260.md) |
| OPS-261 | Case Context Batch Processor                          | Feature      | P2-Medium   | Closed           | [archive/ops-261.md](archive/ops-261.md) |
| OPS-262 | AI Assistant Pre-compiled Context Integration         | Feature      | P2-Medium   | Verifying        | [issues/ops-262.md](issues/ops-262.md)   |
| OPS-263 | CaseCombobox Component                                | Feature      | P2-Medium   | Closed           | [archive/ops-263.md](archive/ops-263.md) |
| OPS-264 | SubtaskBuilder Component                              | Feature      | P2-Medium   | Closed           | [archive/ops-264.md](archive/ops-264.md) |
| OPS-265 | CreateTaskModal Component                             | Feature      | P2-Medium   | Closed           | [archive/ops-265.md](archive/ops-265.md) |
| OPS-266 | CreateTaskModal Integration                           | Feature      | P2-Medium   | Closed           | [archive/ops-266.md](archive/ops-266.md) |
| OPS-267 | useTimePeriodGroups Hook                              | Feature      | P2-Medium   | Closed           | [archive/ops-267.md](archive/ops-267.md) |
| OPS-268 | TimePeriodSection Component                           | Feature      | P2-Medium   | Closed           | [archive/ops-268.md](archive/ops-268.md) |
| OPS-269 | CaseDocumentsList Time Grouping                       | Feature      | P2-Medium   | Closed           | [archive/ops-269.md](archive/ops-269.md) |
| OPS-270 | AttachmentPreviewPanel Time Grouping                  | Feature      | P2-Medium   | Closed           | [archive/ops-270.md](archive/ops-270.md) |
| OPS-271 | Team Activity Page Foundation                         | Feature      | P1-High     | Closed           | [archive/ops-271.md](archive/ops-271.md) |
| OPS-272 | Team Activity View Mode                               | Feature      | P1-High     | Closed           | [archive/ops-272.md](archive/ops-272.md) |
| OPS-273 | Timesheet Mode UI                                     | Feature      | P1-High     | Closed           | [archive/ops-273.md](archive/ops-273.md) |
| OPS-274 | Timesheet Inline Editing                              | Feature      | P1-High     | Closed           | [archive/ops-274.md](archive/ops-274.md) |
| OPS-275 | Timesheet Billable Controls                           | Feature      | P1-High     | Closed           | [archive/ops-275.md](archive/ops-275.md) |
| OPS-276 | Team Attribution Toggle                               | Feature      | P2-Medium   | Closed           | [archive/ops-276.md](archive/ops-276.md) |
| OPS-277 | Timesheet Row Merge                                   | Feature      | P2-Medium   | Closed           | [archive/ops-277.md](archive/ops-277.md) |
| OPS-278 | Timesheet Export (PDF/Clipboard)                      | Feature      | P1-High     | Closed           | [archive/ops-278.md](archive/ops-278.md) |
| OPS-279 | Schema - SentEmailDraft + outlookDraftId Field        | Feature      | P1-High     | Closed           | [archive/ops-279.md](archive/ops-279.md) |
| OPS-280 | Graph Service - Draft Mode Toggle                     | Feature      | P1-High     | Closed           | [archive/ops-280.md](archive/ops-280.md) |
| OPS-281 | Email Resolvers - Draft ID Tracking                   | Feature      | P1-High     | Closed           | [archive/ops-281.md](archive/ops-281.md) |
| OPS-282 | Email Drafting Resolver - outlookDraftId              | Feature      | P1-High     | Closed           | [archive/ops-282.md](archive/ops-282.md) |
| OPS-283 | Task Notifications Draft Mode                         | Feature      | P1-High     | Closed           | [archive/ops-283.md](archive/ops-283.md) |
| OPS-284 | Frontend Draft Messaging                              | Feature      | P1-High     | Closed           | [archive/ops-284.md](archive/ops-284.md) |
| OPS-285 | Dual Database Infrastructure with CLI Switching       | Infra        | P2-Medium   | Verifying        | [issues/ops-285.md](issues/ops-285.md)   |
...
### Minimalist Task Creation Modal (Epic) - OPS-263 to OPS-266

**Goal**: Replace the overloaded `TaskDetailModal` (800+ lines handling create + edit) with a focused, polished creation-only modal. Mandatory case linking and estimated time, inline subtask builder, clean minimal layout.

**Key Changes**:

- Drop task type dropdown (defaults to Research)
- Mandatory case picker (searchable combobox)
- Mandatory estimated time field
- Inline subtask builder (local state before save)
- Collapsible description (hidden by default)
- Keep existing `TaskDetailModal` for editing only
...
Phase 2 (after Phase 1):
└── OPS-265: CreateTaskModal Component [blocked by: 263, 264]

Phase 3 (after Phase 2):
└── OPS-266: CreateTaskModal Integration [blocked by: 265]
```

**Phase 1 - Reusable Components** (parallel) - COMPLETED ✅:

- ~~OPS-263: CaseCombobox Component (controlled, modal-friendly case picker)~~ ✅
- ~~OPS-264: SubtaskBuilder Component (local-state subtask list)~~ ✅

**Phase 2 - Main Modal** (after Phase 1) - COMPLETED ✅:

- ~~OPS-265: CreateTaskModal Component (combines all elements)~~ ✅

**Phase 3 - Integration** (after Phase 2) - COMPLETED ✅:

- ~~OPS-266: CreateTaskModal Integration (wire into tasks page)~~ ✅

---

### Collapsible Time Sections for Documents (Epic) - OPS-267 to OPS-270 - COMPLETED ✅

**Goal**: Group documents and attachments by time period (Astazi, Saptamana aceasta, Luna aceasta, Luna trecuta, Mai vechi) with collapsible sections. Reduces visual noise and helps users focus on recent activity.

**Key Benefits**:

- Documents organized by recency, not flat endless scroll
- Older periods collapsed by default, recent periods expanded
- Collapse state persists in localStorage
- Works in both Case Documents tab and /communications attachments
...
Phase 2 (parallel, after Phase 1):
├── OPS-269: CaseDocumentsList Time Grouping [blocked by: 267, 268]
└── OPS-270: AttachmentPreviewPanel Time Grouping [blocked by: 267, 268]
```

**Phase 1 - Foundation** (parallel) - COMPLETED ✅:

- ~~OPS-267: useTimePeriodGroups Hook (shared grouping logic)~~ ✅
- ~~OPS-268: TimePeriodSection Component (collapsible UI)~~ ✅

**Phase 2 - Integration** (parallel, after Phase 1) - COMPLETED ✅:

- ~~OPS-269: CaseDocumentsList Time Grouping (case documents tab)~~ ✅
- ~~OPS-270: AttachmentPreviewPanel Time Grouping (/communications attachments)~~ ✅

---

### Team Activity & Client Timesheet System (Epic) - OPS-271 to OPS-278

**Goal**: Partner oversight of daily/weekly team work + editable timesheets for client invoicing. Two modes: view mode for productivity review, timesheet mode for invoice preparation.

**Key Benefits**:

- **Team oversight**: See what everyone worked on today/this week at a glance
- **Client timesheets**: Generate editable timesheets for invoice attachments
- **Contract-aware**: Hourly contracts show cost, fixed-sum only show time
- **Flexible editing**: Adjust hours, mark non-billable, merge rows
- **Export ready**: PDF and clipboard export for invoicing

**Parallelization Map**:

```
Phase 1:                OPS-271 (Page Foundation)
                             │
Phase 2 (parallel):     OPS-272 (View Mode) + OPS-273 (Timesheet UI)
                             │                     │
Phase 3 (parallel):          │              OPS-274 + OPS-275 + OPS-276
                             │              (Edit)   (Billable) (Attribution)
                             │                     │
Phase 4:                     │              OPS-277 (Merge Rows)
                             │                     │
Phase 5:                     └──────────┬──────────┘
                                        │
                                   OPS-278 (Export)
...
- ~~OPS-271: Team Activity Page Foundation (`/activitate-echipa` page, filters, mode toggle)~~ ✅

**Phase 2 - Core Views** (after Phase 1) - COMPLETE ✅:

- ~~OPS-272: Team Activity View Mode (read-only, grouped by time period + team member)~~ ✅
- ~~OPS-273: Timesheet Mode UI (table view, contract-aware columns)~~ ✅

**Phase 3 - Editing Features** (parallel, after OPS-273) - COMPLETE ✅:

- ~~OPS-274: Timesheet Inline Editing (editable hours/cost, auto-save)~~ ✅
- ~~OPS-275: Timesheet Billable Controls (per-row billable toggle)~~ ✅
- ~~OPS-276: Team Attribution Toggle (show/hide team member names)~~ ✅

**Phase 4 - Advanced Features** (after OPS-274):

- ~~OPS-277: Timesheet Row Merge (combine entries for cleaner invoices)~~ ✅

**Phase 5 - Export** (after OPS-274, OPS-275) - COMPLETE ✅:

- ~~OPS-278: Timesheet Export (PDF generation, clipboard copy)~~ ✅
...
**Goal**: Redirect all outgoing emails from the platform to the user's Outlook Drafts folder instead of sending immediately. Provides a "review before send" safety net until the team is confident in the system.

**Key Changes**:

- All `sendMail` calls redirect to `/me/messages` (Microsoft Graph create draft API)
- Track Outlook draft IDs in database for audit trail
- Environment toggle `EMAIL_SEND_MODE=draft|send` for easy revert
- Frontend messaging updated: "Salvat în Ciorne" instead of "Trimis"
- Task notifications also go to drafts (as requested)
...
Phase 2 (parallel, after Phase 1):
├── OPS-281: Email Resolvers - Draft ID Tracking [blocked by: 279, 280]
├── OPS-282: Email Drafting Resolver - outlookDraftId [blocked by: 279, 280]
├── OPS-283: Task Notifications Draft Mode [blocked by: 280]
└── OPS-284: Frontend Draft Messaging [blocked by: 280]
```
