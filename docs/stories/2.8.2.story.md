...
- [ ] **Create authorization security tests** (services/gateway/**tests**/integration/case-authorization.integration.test.ts)
...
- [ ] **Create integration tests for approval workflows** (apps/web/src/app/cases/**tests**/)
...
- [ ] Add audit log verification tests (services/gateway/**tests**/)
