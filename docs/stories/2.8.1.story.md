...
6. **Backend Unit Tests (Task 22)**
   - Created __tests__/resolvers/firm.resolvers.test.ts (22 tests)
   - Created __tests__/resolvers/case-billing.resolvers.test.ts (14 tests)
...
- services/gateway/__tests__/resolvers/firm.resolvers.test.ts
- services/gateway/__tests__/resolvers/case-billing.resolvers.test.ts
