...
- services/gateway/__tests__/services/user-management.service.test.ts
- services/gateway/__tests__/integration/user-management.integration.test.ts
...
- apps/web/__tests__/hooks/useAuthorization.test.ts
...
- services/gateway/__tests__/services/user-management.service.test.ts (added 3 new security tests)
- services/gateway/__tests__/integration/user-management.integration.test.ts (added rate limiting mock)
...
- [ ] Add E2E test for pending user activation flow (apps/web/__tests__/e2e/user-management.spec.ts)
