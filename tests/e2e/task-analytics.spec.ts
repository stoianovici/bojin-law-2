        ...
        body: JSON.stringify({
          data: {
            delegationAnalytics: {
                  ...
                  suggestedTraining: [
                    {
                      ...
                      priority: 'high',
                      suggestedAction:
                        'Review legal research methodology and database usage training',
                    },
                  ],
                },
              ],
              topDelegationFlows: [
                {
                  fromUserId: 'user-partner',
                  fromUserName: 'John Partner',
                  toUserId: 'user-1',
                  toUserName: 'Jane Associate',
                  count: 10,
                  avgSuccessRate: 0.9,
                },
                {
              ...
              topSavingsCategories: [
                {
                  ...
                  hoursSaved: 2.08,
                  valueSaved: 520,
                  percentageOfTotal: 49.76,
                },
                {
                  category: 'Automation Features',
                  hoursSaved: 1.5,
                  valueSaved: 375,
                  percentageOfTotal: 35.89,
                },
                {
                  category: 'NLP Task Creation',
                  hoursSaved: 0.6,
                  valueSaved: 150,
                  percentageOfTotal: 14.35,
                },
              ],
            },
          },
