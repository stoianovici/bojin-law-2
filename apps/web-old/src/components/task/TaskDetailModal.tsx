          ...
          <div className="max-h-[calc(90vh-140px)] overflow-y-auto px-6 py-4">
            ...
            >
              ...
              <div>
                ...
                {errors.dueDate && (
                  <p className="mt-1 text-sm text-linear-error">{errors.dueDate}</p>
                )}
                {!requiresTime && (
              ...
              <div className="pt-4 border-t border-linear-border-subtle">
                <h3 className="text-sm font-semibold text-linear-text-secondary mb-4">
                  Detalii Specifice
                </h3>
              ...
              {isEditMode && task && (
                <div className="pt-4 border-t border-linear-border-subtle space-y-3">
                  <div className="flex items-center justify-between">
                    <h3 className="text-sm font-semibold text-linear-text-secondary">
                      Timp Înregistrat
                    </h3>
