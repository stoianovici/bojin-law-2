 ...
 * OPS-263: Modal-friendly, controlled case picker
 *
 * A combobox for selecting a case in modal contexts.
 * Opens downward, always shows search, controlled value.
 *
 * Features:
 * - Controlled component (value + onChange)
 * - Opens downward (for modal context)
 * - Search input always visible
 * - Shows selected case when closed
