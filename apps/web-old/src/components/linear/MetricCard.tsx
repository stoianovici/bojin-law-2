 ...
 */
export function MetricCard({ className, value, label, trend, ...props }: MetricCardProps) {
  return (
    <div className={cn('rounded-lg bg-linear-bg-tertiary p-4', className)} {...props}>
 ...
 */
export function MetricGrid({ className, children, columns = 2, ...props }: MetricGridProps) {
  return (
    <div
      className={cn(
        'grid gap-4',
 ...
 * - Small label below
 */
export function BriefingStat({ className, value, label, ...props }: BriefingStatProps) {
  return (
 ...
 */
export function BriefingStatsRow({ className, children, ...props }: BriefingStatsRowProps) {
  return (
    <div
      className={cn('mt-5 flex gap-6 border-t border-linear-border-subtle pt-4', className)}
      {...props}
    >
      {children}
    </div>
