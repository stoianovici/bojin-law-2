 ...
 */
export function WidgetGrid({ className, children, columns = 3, ...props }: WidgetGridProps) {
  return (
    <div
      className={cn(
        'grid gap-5',
      ...
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            {subtitle && <span className="text-[13px] text-linear-text-tertiary">{subtitle}</span>}
          </div>
        </div>
        {action}
      </div>
