...
const CONFIDENCE_COLORS = {
  ...
  low: {
    ...
    text: 'text-linear-text-secondary',
...
export function PatternDetectionPanel({
  ...
  if (!data) {
    return (
      <div className="text-center py-8 text-linear-text-tertiary">Nu există date despre tipare</div>
    );
  }
