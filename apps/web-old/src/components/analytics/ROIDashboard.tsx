    ...
    <div className="bg-linear-bg-secondary rounded-lg border border-linear-border-subtle p-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="text-center p-3 bg-linear-success/10 rounded-lg">
          ...
          <div className="text-xl font-bold text-linear-success">
        ...
        <div className="text-center p-3 bg-linear-error/10 rounded-lg">
          ...
          <div className="text-xl font-bold text-linear-error">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="mt-2 flex items-center gap-2">
              <span
                className={`text-sm font-medium ${growthIsPositive ? 'text-linear-success' : 'text-linear-error'}`}
              >
                {growthIsPositive ? '↑' : '↓'}{' '}
