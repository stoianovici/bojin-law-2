        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-linear-error">
              Sarcini cu termen depășit care necesită atenție
            </p>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-linear-accent/10 border border-linear-accent/30 rounded p-3">
                    <span className="text-sm font-medium text-linear-accent">
                      Acțiune sugerată:
                    </span>
        ...
        <div className="space-y-4">
          {data.criticalTasks.map((task) => {
            ...
            return (
              <div
                key={task.taskId}
                className="bg-linear-bg-secondary rounded-lg border border-linear-error/30 p-6"
              >
