          ...
          {selectedUserData && (
            <div className="bg-linear-bg-tertiary rounded-lg border border-linear-border-subtle p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h5 className="text-sm font-medium text-linear-text-secondary mb-2">
                    Puncte forte
                  </h5>
      ...
      {selectedTab === 'training' && (
        <div className="space-y-4">
          {data.trainingOpportunities.map((opportunity) => (
            ...
            >
              <h4 className="font-semibold text-linear-text-primary mb-4">
              ...
              <div className="space-y-3">
                {opportunity.suggestions.map((suggestion, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="bg-linear-bg-tertiary rounded-lg p-4 border border-linear-border-subtle"
                    >
                      ...
                      <div className="bg-linear-accent/10 border border-linear-accent/20 rounded p-2">
                        ...
                        <span className="text-xs text-linear-accent/80">
