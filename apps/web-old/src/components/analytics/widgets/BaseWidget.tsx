...
export function BaseWidget({
  ...
  return (
    <div
      className={`bg-linear-bg-secondary rounded-lg border border-linear-border-subtle p-4 transition-all duration-200 hover:border-linear-border hover:shadow-[0_4px_12px_rgba(0,0,0,0.4)] ${className}`}
    >
      {/* Header */}
