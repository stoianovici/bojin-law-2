  ...
  describe('Visual indicators', () => {
    it('should show green background for converted deadline items', async () => {
      ...
      await waitFor(() => {
        ...
        const convertedItem = screen
          .getByText('Revizuire contract')
          .closest('.bg-linear-success\\/10');
    ...
    it('should show warning background for unconverted deadlines', () => {
      ...
      const unconvertedItem = screen
        .getByText('Revizuire contract')
        .closest('.bg-linear-warning\\/10');
    ...
    it('should show success background for unconverted action items', () => {
      ...
      // Find the item card container (parent with background color class)
      const unconvertedItem = screen
        .getByText('Pregătire raport legal')
        .closest('.bg-linear-success\\/10');
      expect(unconvertedItem).toBeInTheDocument();
    });
  });
