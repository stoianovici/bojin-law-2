      ...
      >
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 min-w-0 flex-1">
            {!email.isRead && (
              <span className="w-2 h-2 bg-linear-accent rounded-full flex-shrink-0" />
            )}
            <p
              className={clsx(
                'text-sm truncate',
        ...
        {hasName && (
          <p className="text-xs text-linear-text-tertiary truncate mt-0.5 ml-4">{senderEmail}</p>
        )}
        ...
        {email.bodyPreview && (
          <p className="text-xs text-linear-text-muted truncate mt-1 line-clamp-2">
            {email.bodyPreview}
          </p>
        )}
      </button>
