    ...
    <div className="bg-linear-bg-secondary border border-linear-border-subtle rounded-lg shadow-lg p-3">
      ...
      <div className="mt-1 space-y-0.5 text-sm">
        <p className="text-linear-text-secondary">
          Cost:{' '}
          <span className="font-medium text-linear-text-primary">€{item.cost.toFixed(2)}</span>
        </p>
        <p className="text-linear-text-secondary">
          Tokeni:{' '}
...
export function FeatureBreakdownChart({ data, loading }: FeatureBreakdownChartProps) {
  ...
  if (!data || data.length === 0) {
    return (
      <div className="bg-linear-bg-secondary rounded-lg shadow p-6">
        <h3 className="text-lg font-semibold text-linear-text-primary mb-4">
  ...
  return (
    <div className="bg-linear-bg-secondary rounded-lg shadow p-6">
      <h3 className="text-lg font-semibold text-linear-text-primary mb-6">
        Cost pe Funcționalitate
      </h3>
