...
const GROUP_HEADING_STYLES =
  'mb-2 [&_[cmdk-group-heading]]:text-[11px] [&_[cmdk-group-heading]]:font-semibold [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-wider [&_[cmdk-group-heading]]:text-linear-text-tertiary [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5';
      ...
      >
        ...
        >
          <span className="flex items-center gap-1">
            <kbd className="px-1.5 py-0.5 bg-linear-bg-elevated border border-linear-border rounded text-linear-text-tertiary">
              ↑
            </kbd>
            <kbd className="px-1.5 py-0.5 bg-linear-bg-elevated border border-linear-border rounded text-linear-text-tertiary">
              ↓
