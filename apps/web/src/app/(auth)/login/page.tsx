...
function LoginContent() {
  ...
  const handleDevLogin = (e: React.FormEvent) => {
    ...
    if (!success) {
      setError('Credențiale invalide. Folosiți test/test');
    }
  };
          ...
          {isDevMode && (
            <form onSubmit={handleDevLogin} className="space-y-3">
              <div className="text-xs text-linear-text-tertiary text-center mb-2">
                Mod dezvoltare - Folosiți test/test
              </div>
              <input
                type="text"
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-linear-bg-primary px-2 text-linear-text-tertiary">sau</span>
                </div>
              </div>
            </form>
          )}
