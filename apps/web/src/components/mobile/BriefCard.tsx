    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Title/subtitle */}
          <div className="font-medium text-linear-text-primary truncate">{item.subtitle || item.preview}</div>
          ...
          {item.caseName && (
            <div className="text-xs text-linear-text-muted mt-1 truncate">Dosar: {item.caseName}</div>
          )}
        </div>
