  ...
  return (
    <div
      className={cn(
        ...
        interactive &&
          'cursor-pointer hover:-mx-5 hover:bg-linear-bg-hover hover:px-5',
        'last:border-b-0',
        className
      )}
      onClick={onClick}
...
export function TaskListItem({
  ...
  return (
    <ListItem showCheckbox {...props}>
      <div className="mb-1 text-[13px] font-medium text-linear-text-primary">{title}</div>
  ...
  return (
    <ListItem className={cn('items-center justify-between', className)} {...props}>
      <div className="flex min-w-0 flex-col gap-1">
        <span className="font-mono text-xs font-semibold text-linear-accent">
          {caseNumber}
        </span>
