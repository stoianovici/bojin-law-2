  ...
  return [
    {
      name: 'General',
      shortcuts: [
        { keys: [meta, 'K'], description: 'Deschide paleta de comenzi' },
    ...
    },
    {
      ...
      shortcuts: [
        ...
        { keys: ['↵'], description: 'Deschide element selectat' },
    ...
    },
    {
      name: 'Acțiuni Rapide',
      shortcuts: [
        { keys: [meta, 'N'], description: 'Element nou (contextual)' },
        { keys: [meta, 'S'], description: 'Salvează' },
        { keys: [meta, 'F'], description: 'Caută în pagină' },
      ],
    },
  ];
}
...
export function ShortcutReference() {
  ...
  return (
    <Dialog.Root open={isShortcutReferenceOpen} onOpenChange={(open) => !open && closeShortcutReference()}>
      <Dialog.Portal>
        {/* Backdrop */}
        <Dialog.Overlay
          className={clsx(
