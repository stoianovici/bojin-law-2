      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-linear-bg-elevated rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto z-50">
          ...
          <div className="px-6 py-4 space-y-4">
            <div>
              <label className="block text-sm font-medium text-linear-text-secondary mb-1">Case Title</label>
              <div className="text-base text-linear-text-primary">{caseData.title}</div>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-linear-text-secondary mb-1">Case Number</label>
            ...
            <div>
              <label className="block text-sm font-medium text-linear-text-secondary mb-1">Client</label>
              <div className="text-base text-linear-text-primary">{caseData.client?.name || 'N/A'}</div>
            </div>

            <div>
              <label className="block text-sm font-medium text-linear-text-secondary mb-1">Description</label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-linear-text-secondary mb-1">Status</label>
                <div>
              ...
              <div>
                <label className="block text-sm font-medium text-linear-text-secondary mb-1">Opened Date</label>
                <div className="text-base text-linear-text-primary">{formatDate(caseData.openedDate)}</div>
              </div>
            </div>
          ...
          {showRejectForm && (
            <div className="border-t border-linear-border-subtle bg-linear-error/10 px-6 py-4">
              <h3 className="text-sm font-medium text-linear-error mb-2">Provide Rejection Reason</h3>
              <textarea
