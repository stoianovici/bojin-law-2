    ...
    <div className={clsx('flex flex-col h-full bg-white relative', className)}>
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-900">Înregistrări Timp</h2>
          ...
          <tbody className="divide-y divide-gray-200">
            {[...Array(8)].map((_, i) => (
              <tr key={i} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-gray-900">Cercetare juridică</td>
                <td className="px-4 py-3 text-gray-900 font-semibold">{2 + (i % 3)}.5</td>
                <td className="px-4 py-3">
                  <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200">
                    Da
                  </span>
                </td>
                <td className="px-4 py-3 text-gray-600">Analiză precedente cazuri similare</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium text-gray-700">Total Ore Acest Caz:</span>
