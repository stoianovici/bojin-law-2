  ...
  return (
    <div className={clsx('flex flex-col h-full bg-linear-bg-secondary relative', className)}>
          ...
          <tbody className="divide-y divide-linear-border-subtle">
            {[...Array(8)].map((_, i) => (
              <tr key={i} className="hover:bg-linear-bg-hover">
                ...
                <td className="px-4 py-3 text-linear-text-primary font-semibold">{2 + (i % 3)}.5</td>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-linear-text-tertiary">Analiză precedente cazuri similare</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div className="px-6 py-4 border-t border-linear-border-subtle bg-linear-bg-tertiary">
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium text-linear-text-secondary">Total Ore Acest Caz:</span>
