    ...
    <div className={clsx('flex flex-col h-full bg-gray-50 relative', className)}>
      ...
      <div className="px-6 py-4 bg-white border-b border-gray-200">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-900">Notițe Caz</h2>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <h3 className="text-sm font-semibold text-gray-900 mb-1">Notiță {i + 1}</h3>
              ...
              <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                <span className="text-xs text-gray-500">Actualizat acum {i + 1} zi</span>
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-white/90 pointer-events-none">
        <div className="text-center p-8">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Notițe Caz - În Dezvoltare</h3>
